...
If `.agents/product-marketing.md` exists (or `.claude/product-marketing.md`, or the legacy `product-marketing-context.md` filename, in older setups), read it before applying mental models. Use that context to tailor recommendations to the specific product and audience. (This product-marketing context document is created and maintained by the `product-marketing` skill, now vendored at `skills/product-marketing`.)
