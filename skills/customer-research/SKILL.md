...
If `.agents/product-marketing.md` exists (or `.claude/product-marketing.md`, or the legacy `product-marketing-context.md` filename, in older setups), read it before asking questions. Use that context to skip questions already answered. (This product-marketing context document is created and maintained by the `product-marketing` skill, now vendored at `skills/product-marketing`.)
